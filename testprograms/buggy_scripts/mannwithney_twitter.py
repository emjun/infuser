...
# simple typo make the first line a bug, we compare entities with sentiment
# for which we have no information that it's the same AT
u,pvalue_e = mannwhitneyu(r_e,ir_s)
